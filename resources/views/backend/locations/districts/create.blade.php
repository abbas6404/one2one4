...
@section('title')
Create District - Location Management
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Create District</h4>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Create New District</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.locations.districts.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter district name in English" value="{{ old('name') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="bn_name">District Name (Bengali)</label>
                            <input type="text" class="form-control" id="bn_name" name="bn_name" placeholder="Enter district name in Bengali" value="{{ old('bn_name') }}" required>
                        </div>
                        <div class="mt-4">
