        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="header-title">All Districts</h4>
                    <a href="{{ route('admin.locations.districts.create') }}" class="btn btn-primary">
                        <i class="fa fa-plus-circle"></i> Add New District
                    </a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.locations.districts.edit', $district->id) }}" class="btn btn-success btn-sm">
                                        ...
                                        <form id="delete-form-{{ $district->id }}" action="{{ route('admin.locations.districts.destroy', $district->id) }}" method="POST" style="display: none;">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                    </td>
