    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Edit Testimonial</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="page-header">
                        <h2 class="page-title">Edit Testimonial: {{ $testimonial->name }}</h2>
                    </div>
                    ...
                    <div class="form-container">
                        <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Name" value="{{ old('name', $testimonial->name) }}" required>
                                    </div>
                                    
                                    <div class="form-group mb-4">
                                        <label for="content" class="form-label required-field">Content</label>
                                        <textarea class="form-control" id="content" name="content" rows="5" placeholder="Enter Testimonial Content" required>{{ old('content', $testimonial->content) }}</textarea>
                                        <div class="form-help-text">Enter the testimonial message from this person</div>
                                    </div>
                                    
                                    <div class="form-group mb-4">
                                        <label for="location" class="form-label">Location</label>
                                        <input type="text" class="form-control" id="location" name="location" placeholder="Enter Location" value="{{ old('location', $testimonial->location) }}">
                                    </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <select class="form-control" id="blood_group" name="blood_group">
                                                    ...
                                                    @foreach($bloodGroups as $key => $value)
                                                        <option value="{{ $key }}" {{ old('blood_group', $testimonial->blood_group) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <select class="form-control" id="type" name="type" required>
                                                    @foreach($types as $key => $value)
                                                        <option value="{{ $key }}" {{ old('type', $testimonial->type) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="preview-container" id="avatar-preview">
                                            @if ($testimonial->avatar)
                                                <img src="{{ asset($testimonial->avatar) }}" alt="{{ $testimonial->name }}" class="current-avatar">
                                            @else
                                                <span class="preview-placeholder">No avatar available</span>
                                            @endif
                                        </div>
                                        <div class="file-upload-container">
                                            <div class="file-upload-btn">
                                                <i class="fa fa-upload mr-1"></i> Change Avatar Image
                                            </div>
                                        ...
                                        <div class="form-help-text">Upload a new photo to replace the existing one. Max 2MB.</div>
                                    </div>
                                    
                                    <div class="form-group mb-4">
                                        <label for="order" class="form-label required-field">Display Order</label>
                                        <input type="number" class="form-control" id="order" name="order" min="1" value="{{ old('order', $testimonial->order) }}" required>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-submit">Update Testimonial</button>
                            </div>
                        </form>
                    </div>
                </div>
